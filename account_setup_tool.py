...
def main():
    parser = GooeyParser(description='This program reads in data generated by PS, and creates csv files with all the '
                                     'required info needed to create student accounts with Dovestone/active directory')
